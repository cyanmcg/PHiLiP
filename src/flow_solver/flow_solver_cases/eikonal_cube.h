#ifndef __EIKONAL_CUBE_H__
#define __EIKONAL_CUBE_H__
...
class EikonalCube : public FlowSolverCaseBase<dim,nstate>
{
public:
    /// Constructor.
    EikonalCube(const Parameters::AllParameters *const parameters_input);
